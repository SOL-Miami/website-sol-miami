...
class Bethlehem_ShortcodeQueryBuilder {
...
if ( ! function_exists( 'custom_wp_query' ) ) :
	function custom_wp_query($args = null, $content = null) {
		global $custom_query, $wp_query, $paged;

		// Initiate shortcode query builder class
		$shortcodeQuery = new Bethlehem_ShortcodeQueryBuilder();
