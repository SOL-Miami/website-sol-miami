...
<div class="tribe-venue-widget-wrapper">
	...
	<div class="tribe-events-link">
		<a href="<?php echo esc_url( tribe_get_venue_link( $venue_ID, false ) ); ?>"><?php printf( __( 'View all %1$s at this %2$s', 'bethlehem' ), $events_label_plural, tribe_get_venue_label_singular() ); ?></a>
	</div>
</div>
