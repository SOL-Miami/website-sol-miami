	...
	function bethlehem_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				...
				'slug'					=> 'give',
				'source'				=> 'https://downloads.wordpress.org/plugin/give.1.4.1.zip',
				'required'				=> false,
				'version'				=> '1.4.1',
				'force_activation'		=> false,
				'force_deactivation'	=> false,
			...
			array(
				...
				'source'				=> 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.3.1.6.zip',
				'required'				=> false,
				'version'				=> '3.1.6',
				'force_activation'		=> false,
				'force_deactivation'	=> false,
			...
			array(
				...
				'source'				=> 'https://downloads.wordpress.org/plugin/the-events-calendar.4.1.2.zip',
				'required'				=> false,
				'version'				=> '4.1.2',
				'force_activation'		=> false,
				'force_deactivation'	=> false,
