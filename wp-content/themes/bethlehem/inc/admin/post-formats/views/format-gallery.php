<div id="cfpf-format-gallery-preview" class="cf-elm-block cf-elm-block-image" style="display: none;">
	<!-- <label><span><?php _e('Gallery Images', 'bethlehem'); ?></span></label> -->
	<div class="cf-elm-container">
		...
		<p class="none"><a href="#" class="button"><?php ($ids) ? _e('Edit Gallery', 'bethlehem') : _e('Add Images to Gallery', 'bethlehem'); ?></a></p>
