...
if( ! class_exists('Featured_Posts_Widget') ) {
	class Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			$this->widget_cssclass    = 'widget_featured_posts';
			$this->widget_description = __( 'Display Featured Posts.', 'bethlehem' );
			$this->widget_id          = 'widget_featured_posts';
			$this->widget_name        = __( 'Featured Posts', 'bethlehem' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'std'   => __( 'Featured Posts', 'bethlehem' ),
					'label' => __( 'Title for widget', 'bethlehem' )
				),
				'post_ids'  => array(
					'type'  => 'text',
					'std'   => '',
					'label' => __( 'Ids of post Separate by comma(,)', 'bethlehem' )
				)
			);
		...
		public function widget( $args, $instance ) {
			...
			bethlehem_get_template( 'widgets/featured-posts-widget.php', array( 'args' => $args,'instance' => $instance ) );
