 ...
 * @since 1.0.0
 */
if( ! class_exists('Bethlehem_Custom_Post_Type_Widgets_Calendar') ) {
	class Bethlehem_Custom_Post_Type_Widgets_Calendar extends WP_Widget {

		public function __construct() {
			$widget_ops = array( 'classname' => 'widget_calendar', 'description' => __( 'A calendar of your site&#8217;s Posts.', 'bethlehem' ) );
			parent::__construct( 'custom-post-type-calendar', __( 'Calendar (Custom Post Type)', 'bethlehem' ), $widget_ops );
		...
		public function widget( $args, $instance ) {
			...
			$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Calendar', 'bethlehem' ) : $instance['title'], $instance, $this->id_base );
