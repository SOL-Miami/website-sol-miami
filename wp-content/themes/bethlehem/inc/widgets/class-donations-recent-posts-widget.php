...
if( ! class_exists('Bethlehem_Widget_Donations_Recent_Posts') ) {
	class Bethlehem_Widget_Donations_Recent_Posts extends WP_Widget {

		/**
		 * Sets up the widgets name etc
		 */
		public function __construct() {
			$this->widget_cssclass    = 'widget_donations_recent_posts';
			$this->widget_description = __( 'Bethlehem Donations Recent Posts.', 'bethlehem' );
			$this->widget_id          = 'widget_donations_recent_posts';
			$this->widget_name        = __( 'Donations Recent Posts', 'bethlehem' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'std'   => __( 'Donations', 'bethlehem' ),
		...
		public function widget($args, $instance) {
			$cache = array();
			if ( ! $this->is_preview() ) {
				$cache = wp_cache_get( 'widget_donations_recent_posts', 'widget' );
			}
			...
			bethlehem_get_template( 'widgets/donations-recent-posts-widget.php', array( 'args' => $args,'instance' => $instance ) );
