...
if( ! class_exists('Events_Sort_By_Month_Widget') ) {
	class Events_Sort_By_Month_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			$this->widget_cssclass    = 'widget_archive events_sort_by_month';
			$this->widget_description = __( 'Diaplay Events List by Months.', 'bethlehem' );
			$this->widget_id          = 'widget_events_sort_by_month';
			$this->widget_name        = __( 'Events Sort By Month', 'bethlehem' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'std'   => __( 'Events Sort By Month', 'bethlehem' ),
					'label' => __( 'Title for widget', 'bethlehem' )
				),
				'number_of_month'  => array(
					'type'  => 'text',
					'std'   => '',
					'label' => __( 'Number of months to display.', 'bethlehem' )
				)
			);
		...
		public function widget( $args, $instance ) {
			...
			bethlehem_get_template( 'widgets/events-sort-by-month-widget.php', array( 'args' => $args,'instance' => $instance ) );
